...
If we let the ets() decide which model and which $\alpha$ value work best for the Dept Store Sales data, it outputs that a forecasting model that recognizes multiplicative seasonality and no trend gives a better MAPE. 
