...
Actual sales of souvenirs in 2001 is quite different frm the naive forecast. This is evident in the plot which shows both; the black line delineates the actual sales and the red dotted line represents the naive forecast. Because naive forecasts are generated from the most recent value provided, a straight line of the December 2000 value is all of the informtion available for 2001, so the Dec 2000 sales dictates the  forecast for the year. As we saw from previous data, the time series exhibits seasonality, therefore a seasonal naive forecast would be more appropriate. This is supported by the green dotted line in the plot; this forecast mimics the actual data more closely. 
