...
validationResiduals <- salesValid - HWforecast$mean  
```
...
lines(HWforecast$mean, col = "blue", lty = 2, lwd = 2, type = "b")
lines(validationResiduals, col = "green", lwd = 5, type = "b")
...
plot(validationResiduals, type = "b", col = "green", lwd = 2)
```
