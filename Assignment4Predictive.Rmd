...
#zoom into 4 years
#first create window
DeptSales.ts.zoom <- window(DeptSales.ts, start = c(1, 1), end = c(1, 4))
#plot zooned in data
plot(DeptSales.ts.zoom, xlab = "Time", ylab = "Dept Store Sales", ylim = c(25000, 105000), bty = "l", main = "Dept Store Sales \nZoomed Q-1-Q-2") 
